...
export const alt = 'Mue Marketplace Item';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function OpenGraphImage({ params }: OpenGraphImageProps) {
  ...
  try {
          ...
          >
            ...
            >
              ...
              {data.author && (
                ...
                >
                  <span>by</span>
                  <span style={{ color: '#e4e4e7' }}>{data.author}</span>
                </div>
              )}
            </div>
              ...
              >
                {/* {data.version && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span>Version</span>
                    <span style={{ color: '#a1a1aa' }}>{data.version}</span>
                  </div>
                )} */}
                {data.language && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ color: '#a1a1aa' }}>
                      {new Intl.DisplayNames([data.language], { type: 'language' }).of(
                        data.language,
    ...
    // Fallback OG image if item not found
    return new ImageResponse(
      (
        <div
          style={{
