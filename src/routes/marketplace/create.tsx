...
function CreateAddonPage() {
  ...
  const validateMetadata = () => {
    const checks: [string, string][] = [
      [metadata.name.trim(), 'Please enter a name for your addon.'],
      [metadata.description.trim(), 'Please enter a description for your addon.'],
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-8 px-6 py-12 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        {currentStep > 1 && (
          <DraftManager
            currentDraft={{ addonType, metadata, content: { photos, quotes, settingsJson } }}
