...
export const Route = createFileRoute('/license')({
  head: () => ({
    meta: [
      { title: 'License | Mue' },
      { name: 'description', content: 'Learn about the open source licenses used in Mue.' },
    ],
  }),
    ...
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:py-24">
        <header className="mb-10 text-center sm:mb-16">
          ...
          <p className="mx-auto mt-4 text-base text-muted-foreground">Open source and free to use.</p>
        </header>
        ...
        <div className="space-y-6">
          <LicenseSection
            ...
            description={
              <>
                ...
                and distribute the code, as long as you give appropriate credit.
              </>
            }
            copyrights={
            ...
            links={
              <>
                <GitHubLinkButton href="https://github.com/mue/mue/blob/main/LICENSE" label="View Extension License" />
                <GitHubLinkButton href="https://github.com/mue/website" label="View Website License" />
              </>
            }
          />
          ...
          <LicenseSection
            ...
            copyrights={
              <>
                <CopyrightNotice label="API" year={`2019-${currentYear}`} holder="The Mue Authors" />
                <CopyrightNotice label="Marketplace" year={`2020-${currentYear}`} holder="The Mue Authors" />
              </>
            }
            links={
              <>
                <GitHubLinkButton href="https://github.com/mue/api" label="View API License" />
                <GitHubLinkButton href="https://github.com/mue/marketplace" label="View Marketplace License" />
              </>
            }
          />
          ...
          <section className="rounded-2xl border border-[#FF5C25]/20 bg-gradient-to-br from-[#FF5C25]/10 to-[#FF456E]/10 p-8">
            ...
            <p className="mt-3 text-muted-foreground">
              Mue is built by the community, for the community. All of our code is publicly available on
              GitHub, and we welcome contributions from everyone.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-border bg-background/40 p-4">
                <h4 className="font-semibold text-foreground">Transparent</h4>
                <p className="mt-1.5 text-sm text-muted-foreground">Every line of code is open for inspection.</p>
              </div>
              <div className="rounded-xl border border-border bg-background/40 p-4">
                <h4 className="font-semibold text-foreground">Community-Driven</h4>
                <p className="mt-1.5 text-sm text-muted-foreground">Built with contributions from developers worldwide.</p>
              </div>
            </div>
          </section>
