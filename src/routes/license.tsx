        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-[#FF5C25]/20 bg-gradient-to-br from-[#FF5C25]/10 to-[#FF456E]/10 p-8">
            ...
            <p className="mt-3 text-muted-foreground">
              Mue is built by the community, for the community. All of our code is publicly
              available on GitHub, and we welcome contributions from everyone.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-border bg-background/40 p-4">
                <h4 className="font-semibold text-foreground">Transparent</h4>
                <p className="mt-1.5 text-sm text-muted-foreground">
                  Every line of code is open for inspection.
                </p>
              </div>
              <div className="rounded-xl border border-border bg-background/40 p-4">
