...
export const Route = createFileRoute('/docs/')({
  ...
  head: () => ({
    meta: [
      ...
      { property: 'og:title', content: 'Documentation | Mue' },
      {
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_260px]">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link to="/docs/introduction" className={cn(buttonVariants({ size: 'lg' }))}>
                Get started
                <ArrowRight className="size-4" />
              </Link>
              <Link to="/demo" className={cn(buttonVariants({ variant: 'ghost', size: 'lg' }))}>
                View live demo
              </Link>
            </div>
          </div>
